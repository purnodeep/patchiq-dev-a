...
export const APIWebhookSettingsPage = () => {
  ...
  if (isLoading) {
    return (
      <div style={{ padding: '28px 40px 80px', maxWidth: 720 }}>
        <SkeletonCard />
      </div>
    );
  }
  ...
  return (
    <div style={{ padding: '28px 40px 80px', maxWidth: 720 }}>
      ...
      <div style={{ paddingBottom: 16, borderBottom: '1px solid var(--border)', marginBottom: 24 }}>
        ...
        >
          Integration endpoints, API keys, and outbound event subscriptions.
        </p>
      </div>
      ...
      <APIWebhookSettings settings={s} onSave={handleSave} saving={saving} />
    </div>
  );
};
