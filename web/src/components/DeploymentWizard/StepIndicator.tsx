import { WIZARD_STEPS, type WizardStepId } from '../../types/deployment-wizard';
                ...
                style={{
                  ...
                  background: isCurrent
                    ...
                    : isCompleted
                      ...
                      : 'var(--bg-inset)',
                  border: `1.5px solid ${isCurrent ? 'var(--accent)' : isCompleted ? 'color-mix(in srgb, var(--accent) 40%, transparent)' : 'var(--border)'}`,
